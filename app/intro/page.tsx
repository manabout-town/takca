  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-gray-900 tracking-tight">화물로</span>
          </Link>
          <div className="hidden md:flex items-center gap-6 text-sm text-gray-500">
            <a href="#features" className="hover:text-gray-900">기능</a>
            <a href="#how" className="hover:text-gray-900">이용 방법</a>
            <a href="#pricing" className="hover:text-gray-900">요금</a>
            <a href="#stats" className="hover:text-gray-900">현황</a>
          </div>
          <div className="flex items-center gap-2">
            <Link href="/login" className="text-sm text-gray-500 hover:text-gray-900 px-3 py-1.5">로그인</Link>
      ...
      <section id="stats" className="border-y border-gray-100 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 py-14 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={s.label}>
              <div className="text-3xl font-bold text-gray-900 mb-1">{s.num}</div>
      ...
      <section id="features" className="py-20">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">핵심 기능</h2>
            <p className="text-gray-500">운송 업무를 더 쉽고 안전하게 만드는 기능들</p>
          </div>
      ...
      <section id="how" className="py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">이용 방법</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <div className="text-sm font-semibold text-gray-400 mb-6 uppercase tracking-widest">화주</div>
              <div className="space-y-5">
                {["회원가입 (무료)", "의뢰 등록 — 출발/도착/화물/금액 입력", "기사 매칭 알림 수신", "에스크로 결제 후 운송 완료"].map((s, i) => (
                  <div key={s} className="flex items-start gap-4">
                    <span className="w-7 h-7 bg-gray-900 text-white rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">{i+1}</span>
            ...
            <div>
              <div className="text-sm font-semibold text-gray-400 mb-6 uppercase tracking-widest">기사</div>
              <div className="space-y-5">
      ...
      <section id="pricing" className="py-20">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">투명한 요금</h2>
            <p className="text-gray-500">숨겨진 수수료 없이 명확하게</p>
          </div>
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={p.title} className="bg-white border border-gray-200 rounded-2xl p-6">
                ...
                <div className="text-3xl font-bold text-gray-900 mb-3">{p.price}</div>
      ...
      <section className="py-20 bg-gray-950 text-white text-center">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-400 mb-10 text-lg">가입비, 월정액 없음. 지금 바로 무료로 시작할 수 있습니다.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/signup?role=shipper" className="bg-white hover:bg-gray-100 text-gray-900 px-8 py-3.5 rounded-xl font-semibold transition-colors text-sm">화주로 시작하기</Link>
            <Link href="/signup?role=driver" className="border border-gray-700 hover:border-gray-500 text-gray-300 px-8 py-3.5 rounded-xl font-semibold transition-colors text-sm">기사로 시작하기</Link>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-950 border-t border-gray-900 py-8">
        <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-gray-600 text-sm">
          <div className="flex items-center gap-2">
            <span>🚛</span>
            <span className="font-bold text-gray-400 tracking-tight">화물로</span>
          </div>
