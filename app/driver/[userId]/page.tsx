    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-6 py-10 space-y-6">
        ...
        <div className="bg-white rounded-2xl p-6">
          <h2 className="font-bold text-gray-900 mb-5 text-lg">차량 정보</h2>
        ...
        {/* 리뷰 */}
        <div className="bg-white rounded-2xl p-6">
          <h2 className="font-bold text-gray-900 mb-5 text-lg">받은 리뷰 ({reviews?.length ?? 0})</h2>
        ...
        <div className="text-center pt-2">
          <Link href="/signup" className="inline-block bg-orange-500 hover:bg-orange-600 text-white px-6 py-2.5 rounded-xl text-sm font-semibold transition-colors">
            이 기사님과 거래하기
          </Link>
        </div>
      </div>
